...
st.markdown("Hemos seleccionado sólo las columnas relevantes para esta aplicación pero puedes descargarla completa seleccionando 'Import' y luego 'Import Files'.")
...
CHECKS_AND_ERRORS = [
    (
        ...
        "Para hacerlo selecciona el ícono de filtro de la columna 'ocup_ref', y luego agregando el filtro '=' a 1."
    ),
    (
    ...
    (
        ...
        "Para hacerlo deselecciona 'Edit entire column' y agrega la ecuación '=sum(ingreso_ponderado1\:ingreso_ponderado93103)' en la célula 1 de la columna 'resultados'"
    ),
    (
        ...
        "Para hacerlo deselecciona 'Edit entire column' y  agrega la ecuación '=sum(fact_cal_esi1\:fact_cal_esi93103)' en la célula 3 de la columna 'resultados'"
    ),
    (
        ...
        "Para hacerlo deselecciona 'Edit entire column' y agrega la ecuación '=resultado1/resultado3' en la célula 5 de la columna 'resultados'"
    ),
]
...
if checks_passed:
    ...
    st.write(f"Número de personas ocupadas en Chile es: {n_ocupados:,.0f}".replace(',','.'))
